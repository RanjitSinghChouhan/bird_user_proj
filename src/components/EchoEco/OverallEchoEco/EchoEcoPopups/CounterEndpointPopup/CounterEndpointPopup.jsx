...
function CounterEndpointPopup({ visible, onClose, url }) {
  ...
  const handleClose = (e) => {
    if (e.target.id === "counter-endpoint-container") onClose();
  };
  if (!visible) return null;
  return (
    <div
      id="counter-endpoint-container"
      onClick={handleClose}
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl p-4 relative w-2/4">
        ...
        <div className="text-xl text-[#AEAEAE]">
          This endpoint provides you with the total number of trees and algae
          planted by you with the help of byrds till date.
        </div>
        <form>
          <div className="w-full my-6 relative">
            ...
            {isApiCopied ? <div className="absolute right-1 top-1 GreenGradient">Copied!!!</div> : ""}
            <br />
...
export default CounterEndpointPopup;
